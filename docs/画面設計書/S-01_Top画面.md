...
| 2 | ヒーロー | アイキャッチ文「AIが、あなた専用のIELTS問題をつくる。」＋見出し「解いた分だけ、新しい問題に出会える。」＋説明文＋CTA3種（無料ではじめる／ログイン／ゲストとして始める）＋実写真＋生成中を示す浮遊ステータスカード |
...
| 9 | フッター | タグライン「解いた分だけ、新しい問題に。」＋ロゴ＋SNSアイコン＋コピーライト＋[プライバシーポリシー（S-08）](./S-08_プライバシーポリシー画面.md)・[利用規約（S-09）](./S-09_利用規約画面.md)へのリンク |
